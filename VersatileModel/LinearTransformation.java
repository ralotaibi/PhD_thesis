...
/**
 * The Baseline2 that always assume linear shift and use linearly adapted threshold.
...
{
    //Baseline 2 using alpha and beta without KS
	public static void main(String[] args) throws Exception 
	{
		...
		Instances D_deploy;		
		int i,j;
		BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/ra12404/Desktop/weka-3-7-10/data/Linear_1_4_16.csv"));
			 ...
			 path="/Users/ra12404/Desktop/weka-3-7-10/data/Datashift/"+mydataset+"/run"+(run+1);
				...
				for(degreeShift=0;degreeShift<11;degreeShift++)//1: original, 2: nonlinear, 11: mixture, others:linear
					...
					for(int f = 0; f < numFolds; f++) 
					{
					    ...
					    double alpha,beta,m1,o1,m2,o2,var;
