	...
	/**
	 * The Baseline1 that always uses the trained model ignoring context changes.
...
import weka.estimators.DiscreteEstimator;
	...
	{
		//This is baseline 1 using the original model without KS
		...
		public static void main(String[] args) throws Exception 
		{
			...
			Evaluation eval ;
			int numFolds=5;
			int degreeShift,run;//make it dynamic
			int maxrun=5;
			...
			Instances D_deploy;		
			int i,j;
			BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/ra12404/Desktop/weka-3-7-10/data/OM_1_4_16.csv"));
