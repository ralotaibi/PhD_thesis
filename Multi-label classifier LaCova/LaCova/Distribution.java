...
public class Distribution implements Cloneable, Serializable, RevisionHandler
{
  ...
  public Distribution(int numBags,int numClasses)
 {
   ...
   */
  public Distribution(Instances source, int label) throws Exception
 {
    
    m_perClassPerBag = new double [1][0];
    m_perBag = new double [1];
    totaL = 0;
    int numValues = source.attribute(label).numValues();
    m_perClass = new double [numValues];
    m_perClassPerBag[0] = new double [numValues];
    Enumeration enu = source.enumerateInstances();
    while (enu.hasMoreElements())
      add(0,(Instance) enu.nextElement(),label);
  }
  ...
  public final int actualNumClasses(int bagIndex)
 {
   ...
   * @exception Exception if something goes wrong
   */
  public final void add(int bagIndex,Instance instance,int label) throws Exception
  {    
    int classIndex;
    double weight;
    classIndex = (int)instance.value(label); //value of label l either 0 or 1
   ...
   * @exception Exception if something goes wrong
   */
  public final void sub(int bagIndex,Instance instance,int label) throws Exception
  {
    int classIndex;
    double weight;
    classIndex = (int)instance.value(label); //value of label l either 0 or 1
  ...
  public final void add(int bagIndex, double[] counts)
 {
   ...
   * @exception Exception if something goes wrong
   */
  public final void addInstWithUnknown(Instances source,int attIndex, int label)throws Exception
    {
   ...
   * @exception Exception if something goes wrong
   */
  public final void addRange(int bagIndex,Instances source,int startIndex, int lastPlusOne, int label)throws Exception
    {
   ...
   * @exception Exception if something goes wrong
   */
  public final void addWeights(Instance instance, double [] weights, int label)throws Exception
 {
    int classIndex;
    int i;
  ...
  public final boolean check(double minNoObj)
 {
   ...
   * @exception Exception if something goes wrong
   */
  public final void del(int bagIndex,Instance instance, int label) throws Exception
  {
    int classIndex;
    double weight;
    classIndex = (int)instance.value(label); //value of label l either 0 or 1;
   ...
   * @exception Exception if something goes wrong
   */
  public final void delRange(int bagIndex,Instances source,int startIndex, int lastPlusOne, int label)throws Exception
  {
    double sumOfWeights = 0;
    int classIndex;
    Instance instance;
  ...
  public final double total()
 {
   ...
   * @exception Exception if something goes wrong
   */
  public final void shift(int from,int to,Instance instance, int label) throws Exception
  {
    int classIndex;
    double weight;
   ...
   * @exception Exception if something goes wrong
   */
  public final void shiftRange(int from,int to,Instances source,int startIndex,int lastPlusOne, int label) throws Exception
 {    
    int classIndex;
    double weight;
    Instance instance;
