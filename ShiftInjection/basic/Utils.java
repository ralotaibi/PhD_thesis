...
/*  public static Object forName(Class classType,
  ...
  /**
   * Calculates the Pearson correlation between two arrays of doubles
   * 
   * @param scores1, scores2: the two arrays to be correlated
   * @return the correlation between scores1 and scores2
   */
